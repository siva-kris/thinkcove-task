  ...
  const Cardimg = [
    {
      id: 1,
      img: [
        "https://a0.muscache.com/im/pictures/miso/Hosting-50699164/original/8ab5140b-dbf1-4d0e-a026-d5735af23703.jpeg?im_w=1200",
        "https://a0.muscache.com/im/pictures/da6350c6-9a02-4b24-be0c-b1d73af037d4.jpg?im_w=720",
        "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6NTA2OTkxNjQ%3D/original/74afc232-d1e6-49f2-a1bf-4e81ba59c637.jpeg?im_w=720",
        "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6NTA2OTkxNjQ%3D/original/98fab02b-e6c6-4a1e-9021-bb465dbfbb2c.jpeg?im_w=720",
        "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6NTA2OTkxNjQ%3D/original/8d08f1b5-7bd3-4d47-8b39-ebc9741ce076.jpeg?im_w=720",
      ],
    },
  ];
      ...
      <div className="mx-3">
        ...
        <div className="setdetails">
          <Container>
            <Row>
              <Col sm={8}>
                <h3>Entire chalet in Georgia</h3>
                <p>7 guests1 bedroom3 beds1 bathroom</p>
                <hr></hr>
                <Row className="p-3">
                  {" "}
                  <Col xs="auto">
                  ...
                  <Col className="d-flex align-items-center">
                    <h6 className="mb-0">
                      Hosted by Giorgi <br></br>4 years hosting
                    </h6>
                  </Col>
                </Row>
                <hr></hr>
                ...
                <Col>
                  ...
                  <div className="mx-5">
                    <img
                      src="https://a0.muscache.com/im/pictures/a0a56c4e-9859-4b60-b585-0eafdc409bed.jpg?im_w=960"
                      alt=""
                      className="mb-3 "
                      style={{
                        width: "300px",
